...
class ChatBot {
    ...
    initializeResponses() {
        ...
        return {
            ...
            resposta_servicos: `💼 <strong>Nossos principais serviços:</strong><br>
                • Consultas especializadas]<br>
                • Atendimento personalizado]<br>
                • Produtos premium]<br><br>
            ...
            resposta_contato: `📞 <strong>Entre em contato conosco:</strong><br>
                Telefone: (45) 3222-0000<br>
                WhatsApp: (45) 98411-5699<br>
                Email: contato@emporiodasy.com<br><br>
            ...
            resposta_localizacao: `📍 <strong>Nossa localização:</strong><br>
                Rua Alterio Sordi, 832<br>
                Veneza - Cascavel/PR<br>
                CEP: 85818-155<br><br>
    ...
    addMessage(message, sender, isHTML = false) {
        ...
        const avatar = sender === 'user' ? 'U' : '<img src="assets/Logo 1 200x100.png" alt="Bot">'
